##############################################################
# Description : Run Post-Route Optimization
...
### variables
set current_step "08_innovus_routeopt"
set before_step  "07_innovus_route"
...
source scripts/viewDefinition.postroute.tcl
...
setOptMode -addInstancePrefix "POSTROUTE_" -addNetPrefix "POSTROUTE_NET_"
setOptMode -powerEffort none
setTieHiLoMode -maxFanout 2 -honorDontTouch true -honorDontUse true -prefix "POSTROUTE_TIE_" -cell {TIEHI TIELO}
...
optDesign -expandedViews -setup -hold -drv -outDir "myreports/${current_step}/innovus_routeopt" -postRoute -prefix "innovus_routeopt"
